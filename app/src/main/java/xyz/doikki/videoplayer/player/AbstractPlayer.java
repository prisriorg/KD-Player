...
public abstract class AbstractPlayer {
    ...
    public abstract void myPl(Context context);

    public abstract IjkTrackInfo[] getTrackInfo();
    public abstract void selectTrack(int trackType);
    public abstract void deselectTrack(int trackType);
    public abstract int selectedTrack(int trackType);
