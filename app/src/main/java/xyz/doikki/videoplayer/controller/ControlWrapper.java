...
public class ControlWrapper implements MediaPlayerControl, IVideoController {
    ...
    public IjkTrackInfo[] getTrackInfo() {
        return mPlayerControl.getTrackInfo();
    }

    @Override
    public void selectTrack(int trackType) {
        mPlayerControl.selectTrack(trackType);
    }

    @Override
    public void deselectTrack(int trackType) {
        mPlayerControl.deselectTrack(trackType);
    }

    @Override
    public int selectedTrack(int trackType) {
        return mPlayerControl.selectedTrack(trackType);
    }
